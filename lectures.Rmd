...
`r i <- i + 1; d[i]` [Causal inference](lecture-11-05-2021.html).
 
***

`r i <- i + 1; d[i]` [Sampling designs for surveys](lecture-11-08-2021.html). The [study guide](e5-studyguide.html) for the fifth examination is now available.

`r i <- i + 1; d[i]` [Misconceptions and limitations of statistical tests](lecture-11-10-2021.html).

`r i <- i + 1; d[i]` **Fifth examination**. 
 
***

`r i <- i + 1; d[i]` [Goodness-of-fit tests](lecture-11-15-2021.html).

`r i <- i + 1; d[i]` [Tests of independence](lecture-11-17-2021.html). A set of [homework problems](homework-15.html) on goodness-of-fit tests and tests of independence is now available.
 
`r i <- i + 1; d[i]` [Mark-recapture studies](lecture-11-19-2021.html). A set of [homework problems](homework-16.html) on mark-recapture studies is now available.
...
`r i <- i + 1; d[i]` [Cramer's V and McNemar's test](lecture-11-29-2021.html). Instead of a homework assignment on these topics, assume that any computational problems on these topics on the examination will use the examples from lecture (but with different numbers). The [study guide](e6-studyguide.html) for the sixth examination is now available.

`r i <- i + 1; d[i]` [Simpson's paradox, Berkson's paradox, the ecological fallacy, suppressor variables, and spurious relationships](lecture-12-01-2021.html).

`r i <- i + 1; d[i]` **Sixth examination**.
 
***

`r i <- i + 1; d[i]` [Correlation](lecture-12-06-2021.html). The [study guide](final-studyguide.html) for the final examination is now available.

`r i <- i + 1; d[i]` [Regression and the analysis of variance](lecture-12-08-2021.html). 

`r i <- i + 1; d[i]` No class, but I will be available during my office hours if you want to drop by with questions. I may relocate to the classroom if several students request it so that they can ask questions about the material for the final examination. If this happens I will send out an email. 
