...
`r i <- i + 1; d[i]` [Tests of independence](lecture-11-17-2021.html). A set of [homework problems] on goodness-of-fit tests and tests of independence is now available.
