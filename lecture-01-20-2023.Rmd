...
p <- p + scale_y_continuous(labels = NULL) + labs(x = latex2exp::TeX("$x$"), y = "Relative Frequency")
p1 <- p
...
p <- p + labs(x = latex2exp::TeX("$x$"), y = "Cumulative Relative Frequency")
p2 <- p
```
