...
**Example**: Consider the distribution of observations of the heights of Hobbits from the East and West Farthings.
...
p <- p + labs(x = "Height (m)", y = "Relative Frequency", fill = "Farthing")
