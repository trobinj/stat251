...
<!-- This is not a full lecture, and a little dull. Maybe add discussion of trimmed mean, with the idea is that it is a compromise between the mean and median, with each of those as limiting cases. Could also cover trimean. See Hogg and Tanis.  -->
