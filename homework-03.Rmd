...
p <- p + stat_summary(fun.data = f, geom = "boxplot", fatten = 1, color = "#F8766D") + coord_flip() + labs(y = "Height (cm)")
...
p <- p + stat_summary(fun.data = f, geom = "boxplot", fatten = 1, color = "#00BFC4") + coord_flip() + labs(y = "Height (cm)")
