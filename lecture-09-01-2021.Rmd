...
But clearly the estimate we get would depend on the sample. We could *in theory* consider a *distribution of estimates from many samples/surveys*. This is an approximation of what is called a *sampling distribution*.
